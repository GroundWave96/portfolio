...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div className="group rounded-2xl bg-zinc-900/20 p-6 border border-zinc-800 transition-all hover:border-zinc-700">
      ...
      <p className="mt-2 text-zinc-400 text-sm mb-4">{project.description}</p>
      ...
      <div className="flex w-full gap-3">
        <a 
          ...
          className={`${glassClasses} flex-1 py-2 text-sm font-medium text-zinc-100`}
        >
          Site
        </a>
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className={`${glassClasses} flex-1 py-2 text-sm font-medium text-zinc-300`}
        >
          GitHub
        </a>
      </div>
